...
export const get: APIRoute = async ({ params, request }) => {
    ...
    return new Response(JSON.stringify({
        ...
        publicKey: {
            id: "https://blog-fedi3000.exerra.xyz/.well-known/actor#main-key",
            owner: "https://blog-fedi3000.exerra.xyz/.well-known/actor",
