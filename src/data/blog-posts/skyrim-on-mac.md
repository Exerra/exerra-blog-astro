...
1. Download the DMG version of Porting Kit from [here](https://www.Porting Kit.com/download). **Do not download from any other sources**.
...
When you arrive at the launcher, it will try to detect what settings it should run & will assign you Ultra settings. If you're playing on M1 or M2 **you cannot play with those settings** due to the translation layers.

First set the settings to Low, then click "Advanced" and check that everything in Detail is set to lowest & turned off. Then launch Skyrim, get past the tutorial and if it runs well, start tweaking settings to be higher (everything except view distance will require a restart).
...
This step is tehnically optional, but recommended. SKSE is a script extender for Skyrim and is a required dependency of *many* mods.
...
After that, open a new tab (or window) in Finder (the file manager), go to your Downloads folder and open the downloaded 7z file with The Unarchiver. Then, open the newly created folder, copy the `Data` folder alongside all DLL and EXE files (hold down ⌘ to be able to select multiple files), and paste it into the folder where `SkyrimSE.exe` is located.

And now SKSE is installed!

## Installing Mod Organizer 2

![](https://techphobos.com/wp-content/uploads/2022/02/Mod-Organizer.png)
...
![](https://cdn.discordapp.com/attachments/713134823706984564/1068980719587696793/Screenshot_2023-01-28_at_21.47.37.png)
...
![](https://cdn.discordapp.com/attachments/713134823706984564/1068983670771306506/Screenshot_2023-01-28_at_21.59.20.png)

When that is done, launch Mod Organizer 2 through the shortcut you just made and follow the setup. If it doesn't launch, restart your Mac. Also, if it throws a warning about not being able to load something, either click ignore, or blacklist the plugin.
...
![](https://cdn.discordapp.com/attachments/713134823706984564/1069006392956043324/image.png)
...
![](https://cdn.discordapp.com/attachments/713134823706984564/1069007139152085113/image.png)
...
Then, unzip it, go into the folder and go to "LinuxVersion". That folder contains a DLL that you have to paste into the Skyrim installation folder. In case you have forgot how to go there, refer back to the [Installing SKSE](#installing-skse) section.
